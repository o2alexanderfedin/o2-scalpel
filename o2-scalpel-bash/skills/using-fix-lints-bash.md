---
name: using-fix-lints-bash
description: When user asks to apply lsp diagnostic quick-fixes in Bash, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **bash**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "bash"}}
```
