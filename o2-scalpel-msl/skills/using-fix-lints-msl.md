---
name: using-fix-lints-msl
description: When user asks to apply lsp diagnostic quick-fixes in MSL, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **msl**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "msl"}}
```
