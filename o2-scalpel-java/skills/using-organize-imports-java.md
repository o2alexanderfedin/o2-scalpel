---
name: using-organize-imports-java
description: When user asks to remove unused imports and sort import order in Java, use organize_imports
type: skill
---
...
Invoke `organize_imports` (language: **java**) when the user says any of:
...
```json
{"tool": "organize_imports", "arguments": {"path": "<file>", "language": "java"}}
```
