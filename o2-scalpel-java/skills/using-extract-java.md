---
name: using-extract-java
description: When user asks to extract selection into a method or variable in Java, use extract
type: skill
---
...
Invoke `extract` (language: **java**) when the user says any of:
...
```json
{"tool": "extract", "arguments": {"path": "<file>", "language": "java"}}
```
