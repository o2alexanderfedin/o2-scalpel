---
name: using-fix-lints-haskell
description: When user asks to apply hlint + retrie diagnostic quick-fixes in Haskell, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **haskell**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "haskell"}}
```
