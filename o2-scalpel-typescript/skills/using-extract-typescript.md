---
name: using-extract-typescript
description: When user asks to extract selection into a function, variable, or constant in TypeScript, use extract
type: skill
---
...
Invoke `extract` (language: **typescript**) when the user says any of:
...
```json
{"tool": "extract", "arguments": {"path": "<file>", "language": "typescript"}}
```
