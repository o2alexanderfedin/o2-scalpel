---
name: using-fix-lints-r
description: When user asks to apply lsp diagnostic quick-fixes in R, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **r**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "r"}}
```
