---
name: using-fix-lints-zig
description: When user asks to apply lsp diagnostic quick-fixes in Zig, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **zig**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "zig"}}
```
