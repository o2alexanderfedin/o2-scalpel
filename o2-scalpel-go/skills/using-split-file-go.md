---
name: using-split-file-go
description: When user asks to split a go file along symbol boundaries in Go, use split_file
type: skill
---
...
Invoke `split_file` (language: **go**) when the user says any of:
...
```json
{"tool": "split_file", "arguments": {"path": "<file>", "language": "go"}}
```
