...
cd vendor/serena
O2_SCALPEL_RUN_E2E=1 uv run pytest test/e2e/test_e2e_playground_rust.py test/e2e/test_e2e_playground_python.py test/e2e/test_e2e_playground_markdown.py -v "$@"
