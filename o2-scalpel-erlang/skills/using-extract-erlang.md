---
name: using-extract-erlang
description: When user asks to extract selection into a function or variable in Erlang, use extract
type: skill
---
...
Invoke `extract` (language: **erlang**) when the user says any of:
...
```json
{"tool": "extract", "arguments": {"path": "<file>", "language": "erlang"}}
```
