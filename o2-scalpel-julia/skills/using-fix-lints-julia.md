---
name: using-fix-lints-julia
description: When user asks to apply lsp diagnostic quick-fixes in Julia, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **julia**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "julia"}}
```
