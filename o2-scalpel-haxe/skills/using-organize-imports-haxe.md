---
name: using-organize-imports-haxe
description: When user asks to remove unused imports and sort import order in Haxe, use organize_imports
type: skill
---
...
Invoke `organize_imports` (language: **haxe**) when the user says any of:
...
```json
{"tool": "organize_imports", "arguments": {"path": "<file>", "language": "haxe"}}
```
