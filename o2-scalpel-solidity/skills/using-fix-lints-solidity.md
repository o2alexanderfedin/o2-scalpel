---
name: using-fix-lints-solidity
description: When user asks to apply lsp diagnostic quick-fixes in Solidity, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **solidity**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "solidity"}}
```
