---
name: using-inline-csharp
description: When user asks to inline a method at all call sites in C#, use inline
type: skill
---
...
Invoke `inline` (language: **csharp**) when the user says any of:
...
```json
{"tool": "inline", "arguments": {"path": "<file>", "language": "csharp"}}
```
