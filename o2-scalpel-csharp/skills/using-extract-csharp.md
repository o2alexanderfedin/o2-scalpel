---
name: using-extract-csharp
description: When user asks to extract selection into a method or variable in C#, use extract
type: skill
---
...
Invoke `extract` (language: **csharp**) when the user says any of:
...
```json
{"tool": "extract", "arguments": {"path": "<file>", "language": "csharp"}}
```
