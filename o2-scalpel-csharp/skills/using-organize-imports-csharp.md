---
name: using-organize-imports-csharp
description: When user asks to remove unused using directives and sort import order in C#, use organize_imports
type: skill
---
...
Invoke `organize_imports` (language: **csharp**) when the user says any of:
...
```json
{"tool": "organize_imports", "arguments": {"path": "<file>", "language": "csharp"}}
```
