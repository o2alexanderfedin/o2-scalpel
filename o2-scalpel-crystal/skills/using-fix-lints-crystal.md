---
name: using-fix-lints-crystal
description: When user asks to apply crystal compiler + ameba diagnostic quick-fixes in Crystal, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **crystal**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "crystal"}}
```
