---
name: using-fix-lints-json
description: When user asks to apply lsp diagnostic quick-fixes in JSON, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **json**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "json"}}
```
