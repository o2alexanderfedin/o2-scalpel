---
name: using-fix-lints-swift
description: When user asks to apply lsp diagnostic quick-fixes in Swift, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **swift**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "swift"}}
```
