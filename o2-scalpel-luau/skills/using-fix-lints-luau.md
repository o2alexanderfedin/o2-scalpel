---
name: using-fix-lints-luau
description: When user asks to apply lsp diagnostic quick-fixes in Luau, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **luau**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "luau"}}
```
