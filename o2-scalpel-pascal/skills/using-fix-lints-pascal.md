---
name: using-fix-lints-pascal
description: When user asks to apply lsp diagnostic quick-fixes in Pascal, use fix_lints
type: skill
---
...
Invoke `fix_lints` (language: **pascal**) when the user says any of:
...
```json
{"tool": "fix_lints", "arguments": {"path": "<file>", "language": "pascal"}}
```
